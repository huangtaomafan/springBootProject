...
public class IdCardUtil {
    ...
    private String[]   errMsg     = new String[] { "身份证完全正确！", "身份证为空！", "身份证长度不正确！", "身份证有非法字符！",
                                                   "身份证中出生日期不合法！", "身份证校验位错误！" };
    ...
    public String to18() {
        ...
        if (this.is18())
            ...
            return this.idCardNum.substring(0, 6) + "19" + this.idCardNum.substring(6)
                   + this.getCheckBit();
    }
    ...
    public int isCorrect() {
        ...
        /*
         * if(this.is18()){ if(!this.getCheck().equals(this.getCheckBit())){
         * this.error=IdCardTest.CHECK_BIT_ERROR; return this.error; } }
         */
    ...
    private String getCheckBit() {
        ...
        String checkTable[] = new String[] { "1", "0", "X", "9", "8", "7", "6", "5", "4", "3",
                                             "2" };
